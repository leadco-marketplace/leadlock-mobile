...
import { leadsApi, rateApi, reportsApi, PurchasedLead, RatingThumb, CallLogEntry, ReportReason, THUMBS_UP_REASONS, THUMBS_DOWN_REASONS } from '@/lib/api';
      ...
      >
        ...
        {lead.is_old ? (
          ...
          <>
            ...
            {/* ── Reachability chat ──────────────────────────
                Tap-only chips between buyer + lead provider about reaching the
